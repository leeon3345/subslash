  ...
  return (
    <article className="mx-auto max-w-2xl space-y-8 py-6 text-sm leading-relaxed">
      ...
      <Section title="1. 처리하는 개인정보와 목적">
        ...
        <Item title="계정에 저장 (선택)">
          로그인한 뒤 &lsquo;계정에 저장&rsquo;을 직접 누르면, 그 순간의 구독·체크인·연동 계정·환율
          기록 한 벌을 저장합니다. 목적: 다른 기기에서 &lsquo;계정에서 불러오기&rsquo;로 받기.
        </Item>
        <Item title="결제 알림 (선택)">
      ...
      <Section title="2. 보관 기간과 파기">
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            계정에 저장한 기록: 다시 저장하면 이전 것을 덮어쓰고, &lsquo;계정에서 지우기&rsquo;나
            회원 탈퇴로 지웁니다.
          </li>
          <li>
